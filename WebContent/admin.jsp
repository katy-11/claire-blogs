						...
						<div class="post">
							...
							<div class="post-content">
								<div class="post-title">
									...
									if (username != null) {
									%>
									<a href="/ClaireBlogs/admin?action=editPost&id=${p.getPid()}"><button
											class="btn btn-primary">Edit</button></a> <a
										href="/ClaireBlogs/admin?action=deletePost&id=${p.getPid()}">
								...
								<div class="post-category">
									<a
										href="/ClaireBlogs/post?action=${p.getCategory().toLowerCase()}"><c:out
											value="${p.getCategory()}" /></a><span><c:out
