	...
	<div class="container">
		<div class=" header">
			<div class="header-menu">
				<div class="logo-div">
					<a href="/ClaireBlogs/post?action=listRecentPost"> ClaireBlogs
					</a>
				</div>
				<div class="menu-bar">
			...
			<div class="admin-mode row">
				<div class="admin-left col-8">
					<form action="admin?action=edittedAboutPage" method="get"
						id="textareaForm">
						<input type="submit" class="btn btn-primary">				
					</form>
					<textarea name="textareaId" id="textareaId" form="textareaForm">Type your new "ABOUT PAGE" content here</textarea>
				...
				<div class="admin-right col-4">
					<ul class="list-group">
						...
						<a href="/ClaireBlogs/category?action=createNewCategory" > 
							<li class="list-group-item">Create new Category</li></a>
